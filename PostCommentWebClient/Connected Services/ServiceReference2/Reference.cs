...
namespace ServiceReference2
{
    ...
    public partial class Post : object
    {
        ...
        private System.Collections.Generic.List<ServiceReference2.Comment> CommentsField;
        ...
        public System.Collections.Generic.List<ServiceReference2.Comment> Comments
        {
            get
            {
    ...
    public partial class Comment : object
    {
        ...
        private ServiceReference2.Post PostPostIdField;
        
        private int PostPostId1Field;
        ...
        [System.Runtime.Serialization.DataMemberAttribute()]
        public ServiceReference2.Post PostPostId
        {
            get
            {
        ...
        [System.Runtime.Serialization.DataMemberAttribute()]
        public int PostPostId1
        {
            get
            {
                return this.PostPostId1Field;
            }
            set
            {
                this.PostPostId1Field = value;
            }
        }
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.Tools.ServiceModel.Svcutil", "2.0.2")]
    [System.ServiceModel.ServiceContractAttribute(ConfigurationName="ServiceReference2.IPostComment")]
    public interface IPostComment
    {
        ...
        System.Threading.Tasks.Task<bool> AddPostAsync(ServiceReference2.Post post);
        ...
        System.Threading.Tasks.Task<ServiceReference2.Post> UpdatePostAsync(ServiceReference2.Post post);
        ...
        System.Threading.Tasks.Task<ServiceReference2.Post> GetPostByIdAsync(int id);
        ...
        System.Threading.Tasks.Task<System.Collections.Generic.List<ServiceReference2.Post>> GetPostsAsync();
        ...
        System.Threading.Tasks.Task<bool> AddCommentAsync(ServiceReference2.Comment comment);
        ...
        System.Threading.Tasks.Task<ServiceReference2.Comment> UpdateCommentAsync(ServiceReference2.Comment newComment);
        ...
        System.Threading.Tasks.Task<ServiceReference2.Comment> GetCommentByIdAsync(int id);
        ...
        System.Threading.Tasks.Task<System.Collections.Generic.List<ServiceReference2.Post>> GetAllPostsAndRelatedCommentsAsync();
    }
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.Tools.ServiceModel.Svcutil", "2.0.2")]
    public interface IPostCommentChannel : ServiceReference2.IPostComment, System.ServiceModel.IClientChannel
    {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.Tools.ServiceModel.Svcutil", "2.0.2")]
    public partial class PostCommentClient : System.ServiceModel.ClientBase<ServiceReference2.IPostComment>, ServiceReference2.IPostComment
    {
        ...
        public System.Threading.Tasks.Task<bool> AddPostAsync(ServiceReference2.Post post)
        {
            return base.Channel.AddPostAsync(post);
        }
        
        public System.Threading.Tasks.Task<ServiceReference2.Post> UpdatePostAsync(ServiceReference2.Post post)
        {
        ...
        public System.Threading.Tasks.Task<ServiceReference2.Post> GetPostByIdAsync(int id)
        {
            return base.Channel.GetPostByIdAsync(id);
        }
        
        public System.Threading.Tasks.Task<System.Collections.Generic.List<ServiceReference2.Post>> GetPostsAsync()
        {
        ...
        public System.Threading.Tasks.Task<ServiceReference2.Comment> GetCommentByIdAsync(int id)
        {
            return base.Channel.GetCommentByIdAsync(id);
        }
        
        public System.Threading.Tasks.Task<System.Collections.Generic.List<ServiceReference2.Post>> GetAllPostsAndRelatedCommentsAsync()
        {
